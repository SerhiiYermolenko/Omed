...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/addPatientStyle.css">
</head>
<body>
    ...
    <form:form modelAttribute="patient" action="/patients/add" method="post">
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <form:input path="numberInMedList" class="form-control"/>
            </div>
            <div class="form-group">
                <form:label path="firsName">Ім'я:</form:label>
                <form:input path="firsName" class="form-control"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <form:input class="form-control" path="yearOfBirth"/>
            </div>
            <div class="form-group">
                <form:label path="addres">Місце проживання:</form:label>
                <form:input class="form-control" path="addres"/>
            </div>
            <div class="form-group">
                <form:label path="dateOfRequest">Дата звернення:</form:label>
                <form:input class="form-control" path="dateOfRequest"/>
            </div>
            <div class="form-group">
                <form:label path="numberOfMedCard">Номер медичної картки:</form:label>
                <form:input class="form-control" path="numberOfMedCard"/>
            </div>
        ...
        <div class="col-sm-6">
            ...
            <strong>Життя:</strong>
            <form:textarea path="life" class="form-control anamnez" rows="4"></form:textarea>
            <strong> Психічний статус:</strong>
            <form:textarea path="mentalStatus" class="form-control anamnez" rows="4"></form:textarea>
            <strong>Висновок:</strong>
            <form:textarea path="conclution" class="form-control anamnez" rows="4"></form:textarea>
            <div class="form-group">
                <form:label
                        path="nuberOfInduvidualPsychotherapy">Кількість занять індивідуальної психотерапії:</form:label>
                <form:input class="form-control" path="nuberOfInduvidualPsychotherapy"/>
            </div>
            <div class="form-group">
                <form:label path="numberOfGroupPsychotherapy">Кількість занять групової психотерапії:</form:label>
                <form:input class="form-control" path="numberOfGroupPsychotherapy"/>
            </div>
        </div>
        <div class="text-center"><form:button class="btn btn-success btn-lg btn-add">Додати</form:button></div>
    </form:form>
</div>
