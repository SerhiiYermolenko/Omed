...
<div class="conteiner mainList">
    <h2 class="text-center">ШЩоденник</h2>
    <div class="col-sm-6">
        <p class="text-left"><strong>Участь в медичних конференціях:</strong> ${patient.numberInMedList}</p>
        <p class="text-left"><strong>Тема конференції:</strong> ${patient.firsName}</p>
        <p class="text-left"><strong>Проведення виховних робіт в колективі:</strong> ${patient.secondName}</p>
        <p class="text-left"><strong>Тема лекції:</strong> ${patient.yearOfBirth}р.</p>
    </div>
    <div class="col-sm-6">
